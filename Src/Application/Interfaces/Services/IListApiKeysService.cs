...
public interface IListApiKeysService
{
    ...
    /// <returns>Paginated list of API key metadata.</returns>
...
/// <param name="Items">The paginated list of API key metadata.</param>
...
public sealed record ListApiKeysResult(IReadOnlyList<ApiKeyMetadata> Items, int Total, int Limit, int Offset);
